...
export function updatePanelText(indicator, prayerTimesData, iqamaDelays, currentLang) {
...
export function rebuildMenu(indicator, config, prayerTimesData, callbacks) {
    if (!prayerTimesData || !indicator)
        return;
    const now = new Date();
